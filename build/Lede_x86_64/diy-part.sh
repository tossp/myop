...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.9.1'                                    # IPv4 地址(openwrt后台地址)
...
uci set system.@system[0].hostname='opnas-lede'                            # 修改主机名称为OpenWrt-123
EOF
...
# echo 'src-git jddailybonus https://github.com/jerrykuku/luci-app-jd-dailybonus' >>feeds.conf.default
